...
<head>
    ...
    <style>
        ...
        .badge { padding: 6px 12px; border-radius: 20px; font-weight: 500; font-size: 12px; }
    </style>
</head>
<body>
    <div class="sidebar">
    ...
    <div class="main-content">
        <div class="top-navbar"><h4>Categories Management</h4></div>
        <div class="content-area">
            <div class="card">
                <div class="card-header"><i class="fas fa-tags me-2"></i> All Categories</div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            <thead>
                                <tr><th>ID</th><th>Name</th><th>Slug</th><th>Display Order</th><th>Status</th></tr>
                            </thead>
                            <tbody>
                                <?php if (!empty($categories)): foreach ($categories as $cat): ?>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-<?php echo $cat['is_active'] ? 'success' : 'secondary'; ?>"><?php echo $cat['is_active'] ? 'Active' : 'Inactive'; ?></span></td>
                                    </tr>
                                <?php endforeach; else: ?>
