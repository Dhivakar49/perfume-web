...
<body>
    ...
    <div class="main-content">
        <div class="top-navbar"><h4>Settings</h4></div>
        <div class="content-area">
            <div class="card">
                <div class="card-header"><i class="fas fa-cog me-2"></i> Site Settings</div>
                <div class="card-body">
                    <form>
                        <div class="mb-3">
                            <label class="form-label">Site Name</label>
                            <input type="text" class="form-control" value="Perfume Palace" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Admin Email</label>
                            <input type="email" class="form-control" value="admin@perfumepalace.com" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i> Settings management coming soon!
                        </div>
                    </form>
                </div>
            </div>
